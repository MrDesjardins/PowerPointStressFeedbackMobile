...
namespace PowerPointStressFeedbackWeb.Controllers
{
    public class StressFeedbackController : Controller
    {
        ...
        static StressFeedbackController()
        {
            ...
            {
                var minute = 9 + i;
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 00), HeartBeat = 60, Temperature = 37.4d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 01), HeartBeat = 61, Temperature = 37.4d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 02), HeartBeat = 62, Temperature = 37.5d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 03), HeartBeat = 61, Temperature = 37.5d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 04), HeartBeat = 62, Temperature = 37.5d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 05), HeartBeat = 62, Temperature = 37.5d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 06), HeartBeat = 62, Temperature = 37.6d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 07), HeartBeat = 63, Temperature = 37.6d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 08), HeartBeat = 63, Temperature = 37.6d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 09), HeartBeat = 64, Temperature = 37.6d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 10), HeartBeat = 64, Temperature = 37.7d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 11), HeartBeat = 65, Temperature = 37.7d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 12), HeartBeat = 65, Temperature = 37.7d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 13), HeartBeat = 67, Temperature = 37.7d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 14), HeartBeat = 67, Temperature = 37.7d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 15), HeartBeat = 66, Temperature = 37.8d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 16), HeartBeat = 65, Temperature = 37.8d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 17), HeartBeat = 65, Temperature = 37.8d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 18), HeartBeat = 64, Temperature = 37.8d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 19), HeartBeat = 66, Temperature = 37.9d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 20), HeartBeat = 67, Temperature = 37.9d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 21), HeartBeat = 70, Temperature = 37.9d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 22), HeartBeat = 70, Temperature = 37.8d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 23), HeartBeat = 72, Temperature = 37.8d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 24), HeartBeat = 72, Temperature = 37.9d});
                ...
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 41), HeartBeat = 73, Temperature = 37.5d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 42), HeartBeat = 73, Temperature = 37.6d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 44), HeartBeat = 73, Temperature = 37.6d});
                testBandData.Add(new BandData {SessionId = fakeSession, DateTime = new DateTime(2016, 07, 26, 11, minute, 46), HeartBeat = 73, Temperature = 37.6d});
